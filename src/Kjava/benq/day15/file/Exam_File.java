...
public class Exam_File {
	...
	public static void main(String[] args) {
		...
		File forderMake = new File("src/Kjava/benq/day15/file/sample");
		if(!forderMake.exists()) {
			forderMake.mkdir();
	...
	public void fileMake() throws IOException {
		File fileMake = new File("src/Kjava/benq/day15/file/sample.txt");
		if(!fileMake.exists()) {
